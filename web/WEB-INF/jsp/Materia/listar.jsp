<%-- 
    Document   : listar
    Created on : 11/07/2016, 01:06:50 PM
    Author     : Fabian
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa"></i> Lista de Materias
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <p>
                            <a href="${pageContext.request.contextPath}/materia/crear.htm" class="btn btn-ls btn-default">Nuevo</a>
                        </p>
                    </div>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.resultado}" var="a">
                                        <tr>
                                            <td>${a.getIdMateria()}</td>                            
                                            <td>${a.getNombre()}</td>
                                            <td>${a.getNCreditos()}</td>
                                            <td>${a.idmaestro.nombre}</td> 
